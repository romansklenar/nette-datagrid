CREATE ROLE root LOGIN
  ENCRYPTED PASSWORD 'md55a321acc837edaf144f179910b04c267'
  NOSUPERUSER INHERIT NOCREATEDB NOCREATEROLE;


CREATE DATABASE birt
  WITH OWNER = root
       ENCODING = 'UTF8'
-- --------------------------------------------------------
...
ALTER TABLE "Offices" OWNER TO root;
...
CREATE TABLE "Employees" (
  ...
  "officeCode" INTEGER NOT NULL REFERENCES "Offices" ON DELETE RESTRICT,
...
ALTER TABLE "ProductLines" OWNER TO root;
...
ALTER TABLE "OrderDetails" OWNER TO root;
