...
CREATE TABLE `customers` (
  ...
  `contactLastName` varchar(50) collate utf8_unicode_ci NOT NULL,
  `contactFirstName` varchar(50) collate utf8_unicode_ci NOT NULL,
  `phone` varchar(50) collate utf8_unicode_ci NOT NULL,
  `addressLine1` varchar(50) collate utf8_unicode_ci NOT NULL,
  `addressLine2` varchar(50) collate utf8_unicode_ci default NULL,
...
CREATE TABLE `employees` (
  ...
  `officeCode` varchar(10) collate utf8_unicode_ci NOT NULL,
...
CREATE TABLE `offices` (
  ...
  `territory` varchar(10) collate utf8_unicode_ci NOT NULL,
...
CREATE TABLE `payments` (
  `customerNumber` int(11) NOT NULL,
  `checkNumber` varchar(50) collate utf8_unicode_ci NOT NULL,
...
#
# Structure for the `productlines` table : 
#
...
INSERT INTO `customers` (`customerNumber`, `customerName`, `contactLastName`, `contactFirstName`, `phone`, `addressLine1`, `addressLine2`, `city`, `state`, `postalCode`, `country`, `salesRepEmployeeNumber`, `creditLimit`) VALUES 
  ...
  (227,'Heintze Collectables','Ibsen','Palle','86 21 3555','Smagsloget 45',NULL,'',NULL,'8200','Denmark',1401,120800),
  (233,'Qu','Fresni','Jean ','(514) 555-8054','43 rue St. Laurent',NULL,'Montr','Qu','H1J 1C3','Canada',1286,48700),
  ...
  (259,'Toms Spezialit','Pfalzheim','Henriette ','0221-5554327','Mehrheimerstr. 369',NULL,'K',NULL,'50739','Germany',1504,120400),
  ...
  (273,'Franken Gifts, Co','Franken','Peter ','089-0877555','Berliner Platz 43',NULL,'M',NULL,'80805','Germany',NULL,0),
  ...
  (298,'Vida Sport, Ltd','Holz','Mihael','0897-034555','Grenzacherweg 237',NULL,'Gen',NULL,'1203','Switzerland',1702,141300),
  ...
  (361,'Kommission Auto','Josephs','Karin','0251-555259','Luisenstr. 48',NULL,'M',NULL,'44087','Germany',NULL,0),
  ...
  (448,'Scandinavian Gift Ideas','Larsson','Martha','0695-34 6555','',NULL,'Br',NULL,'S-844 67','Sweden',1504,116400),
...
INSERT INTO `offices` (`officeCode`, `city`, `phone`, `addressLine1`, `addressLine2`, `state`, `country`, `postalCode`, `territory`, `position`) VALUES 
  ('1','San Francisco','+1 650 219 4782','100 Market Street','Suite 300','CA','USA','94080','NA',2),
  ('2','Boston','+1 215 837 0825','1550 Court Place','Suite 102','MA','USA','02107','NA',1),
  ('3','NYC','+1 212 555 3000','523 East 53rd Street','apt. 5A','NY','USA','10022','NA',3),
  ('4','Paris','+33 14 723 4404','43 Rue Jouffroy D''abbans',NULL,NULL,'France','75017','EMEA',4),
  ('5','Tokyo','+81 33 224 5000','4-1 Kioicho',NULL,'Chiyoda-Ku','Japan','102-8578','Japan',5),
  ('6','Sydney','+61 2 9264 2451','5-11 Wentworth Avenue','Floor #2',NULL,'Australia','NSW 2010','APAC',7),
  ('7','London','+44 20 7877 2041','25 Old Broad Street','Level 7',NULL,'UK','EC2N 1HN','EMEA',6);
COMMIT;
...
#
# Data for the `orderdetails` table  (LIMIT 500,500)
#
...
#
# Data for the `orderdetails` table  (LIMIT 1000,500)
#
...
#
# Data for the `orderdetails` table  (LIMIT 1500,500)
#
...
#
# Data for the `orderdetails` table  (LIMIT 2000,500)
#
...
#
# Data for the `orderdetails` table  (LIMIT 2500,500)
#
...
#
# Data for the `productlines` table  (LIMIT 0,500)
#
...
INSERT INTO `products` (`productCode`, `productName`, `productLine`, `productScale`, `productVendor`, `productDescription`, `quantityInStock`, `buyPrice`, `MSRP`) VALUES 
  ...
  ('S32_1268','1980','Trucks and Buses','1:32','Motor City Art Classics','This 1980',5099,53.93,96.31),
